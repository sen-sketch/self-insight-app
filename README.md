...
- デプロイ先: https://self-insight-app.vercel.app（Vercel）
...
| S03 習慣トラッカー | `/tracker` | 習慣タスクの管理と開始記録（ダッシュボードからリンク、ボトムナビ非掲載） |
| S04 投稿 | `/post` | タイムライン投稿の入力 |
...
- **PWA**: Service Worker対応（Serwist）、ホーム画面追加可能
